        ...
        ${isCredit ? "C" : "D"}</div>
                     ...
                     <div class="lower"> 
                        <div class="icon" onclick="handleUpdate(${id})">
                            <img src="./pen-solid-full.svg" alt="pen" />
                        </div>
                        <div class="icon"onclick="handleDelete(${id})">
                            <img src="./trash-can-solid-full.svg" alt="trash" />
                        </div>
                     </div>
                    </div>`
...
const addTransaction = (e) => {
    ...
    if(isUpdate){
     ...
     const tIndex = state.transactions.findIndex((t) => t.id === tie);
...
const transactions = state.transactions.find(t=> t.id === id);
